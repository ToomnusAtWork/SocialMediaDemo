...
import { menu, close } from '../../assets/vectors'
        ...
        >
          <div className="m-auto px-2 md:px-8">
            <div className="flex flex-wrap items-center justify-between gap-6 md:py-3 md:gap-0">
                <div className="w-screen flex lg:w-auto">
                    <Link 
                        to="/"
                        ...
                        <span className="text-base font-bold text-gray-600 dark:text-white">SocialSociety</span>
                    </Link>
                  ...
                  <div className="navmenu hidden w-screen flex-wrap justify-end items-center mb-16 space-y-8 p-6 border border-gray-100 rounded-3xl shadow-2xl shadow-gray-300/20 bg-white dark:bg-gray-800 lg:space-y-0 lg:p-0 lg:m-0 lg:flex md:flex-nowrap lg:bg-transparent lg:w-7/12 lg:shadow-none dark:shadow-none dark:border-gray-700 lg:border-0">
                      <div className="text-gray-600 dark:text-gray-300 lg:pr-4">
                          <ul className={`${!toggle ? 'hidden' : 'flex' } space-y-6 tracking-wide gap-4 font-medium text-base lg:text-sm lg:flex lg:space-y-0`}>
                            {navLinks.map((link) => (
                                <li key={link.id} 
                                className={`${ 
                                    active === link.title
                                    ? "text-white"
                                    : "text-red-100"} hover:text-white text-[18px] 
