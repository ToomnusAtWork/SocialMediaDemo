        ...
        <nav className="fixed z-20 w-screen bg-white/80 dark:bg-gray-900/80 backdrop-blur navbar shadow-md shadow-gray-600/5 peer-checked:navbar-active md:relative md:bg-transparent dark:shadow-none">
          <div className="m-auto px-2 md:px-8">
              <div className="flex flex-wrap items-center justify-between gap-6 md:py-3 md:gap-0">
                  <div className="w-screen flex justify-between lg:w-auto">
                        <Link 
                            to="/"
                  ...
                  <div className="navmenu hidden w-full flex-wrap justify-end items-center mb-16 space-y-8 p-6 border border-gray-100 rounded-3xl shadow-2xl shadow-gray-300/20 bg-white dark:bg-gray-800 lg:space-y-0 lg:p-0 lg:m-0 lg:flex md:flex-nowrap lg:bg-transparent lg:w-7/12 lg:shadow-none dark:shadow-none dark:border-gray-700 lg:border-0">
                      <div className="text-gray-600 dark:text-gray-300 lg:pr-4">
                          <ul className={`${!toggle ? 'hidden' : 'flex' } space-y-6 tracking-wide font-medium text-base lg:text-sm lg:flex lg:space-y-0`}>
                            {navLinks.map((link) => (
                                <li key={link.id} 
                                className={`${ 
                                    active === link.title
                      ...
                      <div className="w-screen space-y-2 border-primary/10 dark:border-gray-700 flex flex-col -ml-1 sm:flex-row lg:space-y-0 md:w-max lg:border-l">
