...
const Graphic = () => {
    ...
    //         title: {
    //           display: true,
    //           text: 'Team member participation'
    //         }
    //       }
    //     },
    //   };
    ...
    <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      ...
      <div>
        <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
          <p className="text-base font-semibold leading-7 text-yellow-400">Share your stats with the team</p>
          <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Data visualizations.</h1>
          <div className="max-w-xl">
            <p className="mt-6">You don't have to worry about your team members lacking connectivity. </p>
            <p className="mt-8">Our tool ensures that every member is a part of the team.</p>
            <p className="mt-8">Let's visualize our example data with input from various teams and departments. </p>
          </div>
        </div>
